...
/**
 * Kelas InitSubCerita merepresentasikan kelas yang digunakan untuk mengambil 
 * data untuk keperluan subcerita pada empat pulau.
 *
 */
public class InitSubCerita {
    ...
    public static void initSumatera(Cerita cerita) {
        ...
        while (st.hasMoreTokens()) {
            ...
            if (st2.nextToken().trim().equals("unlocked")) {
                unlocked = true;
            }
        ...
        ((TapGame) cerita.getSubCerita(3)).setBackground(new Texture(Gdx.files.internal("siparkit_tapgame/bg.png")));
        ((TapGame) cerita.getSubCerita(3)).setPanelBackground(new Texture(Gdx.files.internal("siparkit_tapgame/panel_bg.png")));
    ...
    public static void initKalimantan(Cerita cerita) {
        ...
        ((TapGame) cerita.getSubCerita(7)).setBackground(new Texture(Gdx.files.internal("nusa_tapgame/bg.png")));
        ((TapGame) cerita.getSubCerita(7)).setPanelBackground(new Texture(Gdx.files.internal("siparkit_tapgame/panel_bg.png")));
        ...
        for (int j = 0; j < pieces.length; j++) {
            for (int k = 0; k < pieces[j].length; k++) {
                ...
                pieces[j][k] = new PuzzlePiece(new PuzzleTarget(bounds), tmp,
                        new Texture(Gdx.files.internal("ajisaka_puzzle/" + (4 - j) + "_" + (k + 1) + ".png")));
            }
        }
    ...
    public static void initBali(Cerita cerita) {
        ...
        ((RunningGame) cerita.getSubCerita(1)).setPanelBackground(new Texture(Gdx.files.internal("selatbali_running/panel_bg.jpg")));
        ((RunningGame) cerita.getSubCerita(1)).setPlayer(new Texture(Gdx.files.internal("selatbali_running/player.png")));
        ((RunningGame) cerita.getSubCerita(1)).setProgressIcon(new Texture(Gdx.files.internal("selatbali_running/progress_icon.png")));
        ...
        ((TapGame) cerita.getSubCerita(6)).setBackground(new Texture(Gdx.files.internal("selatbali_tapgame/bg.png")));
        ((TapGame) cerita.getSubCerita(6)).setPanelBackground(new Texture(Gdx.files.internal("siparkit_tapgame/panel_bg.png")));
