...
/**
 * Kelas InitLabirin merepresentasikan kelas yang digunakan untuk mengambil data
 * untuk keperluan permainan bertipe Labirin.
 *
 */
public class InitLabirin {
    ...
    public static void initLabirin(Labirin labirin, FileHandle file) {
        ...
        labirin.setPlayerTexture(new Texture[]{
            ...
            new Texture(Gdx.files.internal(st.nextToken().trim())),
            new Texture(Gdx.files.internal(st.nextToken().trim())),});
        labirin.setWallTexture(new Texture(Gdx.files.internal(st.nextToken().trim())));
        labirin.setItemTexture(new Texture(Gdx.files.internal(st.nextToken().trim())));
