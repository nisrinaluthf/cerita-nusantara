 ...
 * Kelas ini juga menerima input dari pengguna dan meneruskannya ke PilihCeritaController
 */
...
public class PilihCeritaScreen extends AbstractScreen {
	...
	public void dispose() {
		super.dispose();
		background.dispose();
		sumateraTexture.dispose();
		sumateraPressedTexture.dispose();
		kalimantanTexture.dispose();
		kalimantanPressedTexture.dispose();
		jawaTexture.dispose();
		jawaPressedTexture.dispose();
		baliTexture.dispose();
		baliPressedTexture.dispose();
		backButtonTexture.dispose();
		backButtonPressedTexture.dispose();
		clickSfx.dispose();
		backClickSfx.dispose();
		pilihCeritaMusicBg.dispose();
	}
}
