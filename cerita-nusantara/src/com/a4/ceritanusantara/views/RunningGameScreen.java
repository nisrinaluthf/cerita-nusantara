...
/**
 * Kelas <code>RunningGameScreen</code> adalah kelas untuk mengatur tampilan game running termasuk suara dan musiknya
 * Kelas ini menerima input dari pengguna dan meneruskannya ke kelas RunningGameController.
 */
...
*/
	...
	public void dispose(){
		...
		leftButtonPressedTexture.dispose();
		rightButtonPressedTexture.dispose();
		
		font.dispose();
		
		hitObstacleSfx.dispose();
